...
<link href="https://fonts.googleapis.com/css2?family=Kosugi+Maru&display=swap" rel="stylesheet">
	...
	<%
	    ...
	    if (shop == null) {
	        response.sendRedirect(request.getContextPath() + "/ShopMenu.action");
	        return;
	    }
	...
	<div class="profile-container">
	    ...
	    <div class="button-section">
	        <%-- 1. 編集リクエスト機能（ShopEditRequest.actionは今後作成） --%>
	        <a href="${pageContext.request.contextPath}/ShopEditRequest.action" class="action-btn btn-edit">
	            店舗情報の編集をリクエスト
	        </a>
	        ...
	        <%-- 3. 削除リクエスト機能（ShopDeleteRequest.actionは今後作成） --%>
	        <a href="${pageContext.request.contextPath}/ShopDeleteRequest.action" class="action-btn btn-delete">
	            店舗の削除をリクエスト
	        </a>
	    </div>
	</div>
