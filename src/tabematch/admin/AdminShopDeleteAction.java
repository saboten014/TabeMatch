...
public class AdminShopDeleteAction extends Action {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse res) throws Exception {
        ...
        if (shopId == null || shopId.trim().isEmpty()) {
            session.setAttribute("errorMessage", "店舗IDが指定されていません。");
            res.sendRedirect(req.getContextPath() + "/tabematch/admin/AdminShopList.action");
            return;
        }
        ...
        try {
            ...
            session.setAttribute("successMessage", "店舗とアカウントを削除しました。");
