...
public class AdminShopDeleteRequestRejectAction extends Action {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse res)
        ...
        String sql = "UPDATE shop_delete_requests SET status = 3 WHERE request_id = ? AND status = 1";
        ...
        if (result > 0) {
            session.setAttribute("successMessage", "削除リクエストを却下しました。");
